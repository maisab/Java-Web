<%-- 
    ...
    Created on : 30/11/2011, 19:21:27
    Author     : Andressa
--%>
                    ...
                    <div id="blocopaginacao">
                        <%
                            ...
                            if (pagina == 1) {
                                ...
                                out.println("<a href=\"ServletBusca?op=buscaEditoras.jsp&paginaAnterior=1&paginas=" + (++pagina) + " \"> > </a>");
                            } else {

                                if (pagina == quantidade) {
                                    out.println("<a href=\"ServletBusca?op=buscaEditoras.jsp&paginaAnterior=" + --paginaA + "&paginas=" + --pagina + " \"> < </a>");

                                } else {
                                    out.print("<a href=\"ServletBusca?op=buscaEditoras.jsp&paginaAnterior=" + (--paginaA) + "&paginas=" + (--pagina) + " \"> < </a> "
                                            + "<a href=\"ServletBusca?op=buscaEditoras.jsp&paginaAnterior=" + (++pA) + "&paginas=" + (++pag) + " \"> > </a>");
